...
import { FULL_RUNNER_STATS, SMALL_RUNNER_STATS } from './__mocks__/mocks';
...
describe('metadata', () => {
    ...
    describe('determineBrowserData', () => {
        ...
        it('should return that the browser name and version based on the capabilities', () => {
            expect(Metadata.determineBrowserData(
                {
    ...
    describe('determineMetadata', () => {
        let determineAppDataSpy, determineBrowserDataSpy, determineDeviceNameSpy, determinePlatformNameSpy, determinePlatformVersionSpy;
        const appMockData = {
            app: {
                name: 'mock-appName',
